...
# Adapted from braindecode (EEGNetv4 and its helper layers):
...
class EEGNetv4(nn.Module):
    def __init__(
        ...
        # Remove the Rearrange layer and handle reshaping manually in forward_features
        ...
        self.conv_classifier = None  # Will be initialized in forward pass
