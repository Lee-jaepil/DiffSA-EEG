...
class Inception(nn.Module):
    def __init__(self, in_channels):
        ...
        # batch normalization on convolution outputs
...
class ChronoNet(nn.Module):
    def __init__(self, input_channels=21, sequence_length=250):
        ...
        # Calculate the size after Inception layers
        self.inception_output_size = sequence_length // 8  # As we have 3 layers with stride 2
        ...
        # LayerNorm on each GRU output
        self.ln1 = nn.LayerNorm(32)
        self.ln2 = nn.LayerNorm(32)
        self.ln3 = nn.LayerNorm(32)
        self.ln4 = nn.LayerNorm(32)
        
        # dropout for regularization and stability
        self.dropout = nn.Dropout(0.3)

        self.fc = nn.Linear(32, 2)  # Final fully connected layer
    ...
    def forward(self, x):
        ...
        # Add an extra dimension for 2D convolutions
